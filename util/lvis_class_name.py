import json
#data = json.load(open("data/lvis/lvis_v1_train_norare_cat_info.json", 'r'))
#LVIS_CLASS_NAME = {}
#LVIS_NOVEL_IDS = []
#LVIS_BASE_IDS = []
#LVIS_ALL_IDS = []
...
#for item in data:
#    LVIS_CLASS_NAME[item['id']] = item['name']

#    if item['frequency'] == 'r':
#        LVIS_NOVEL_IDS.append(item['id'])
#    else:
#        LVIS_BASE_IDS.append(item['id'])

#print("LVIS_CLASS_NAME =", LVIS_CLASS_NAME)
#print("lvis_novel =", LVIS_NOVEL_IDS)
#print("lvis_base =", LVIS_BASE_IDS)
...
LVIS_CLASS_NAME = {
   ...
   "697":"money",
   "698":"monitor_(computer_equipment) computer_monitor",
   "699":"monkey",
   "700":"motor",
   "701":"motor_scooter",
   "702":"motor_vehicle",
